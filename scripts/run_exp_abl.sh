...
mkcmd "\$D1" 4 \
  ...
  --load_hdf5_dataset=0 \\
  --tb_path=sensitivity_scan_tfboard_ablation/door_setX_will_be_overwritten \\
  --log_interval=10000 \\
...
mkcmd "\$L1" 5 \
  ...
  --load_hdf5_dataset=0 \\
  --tb_path=sensitivity_scan_tfboard_ablation/lift_setX_will_be_overwritten \\
  --log_interval=10000 \\
...
new_win_run "h1" "\$H1" "sensitivity_scan_tfboard_ablation/hopper_set1_seed${SEED}"
new_win_run "h2" "\$H2" "sensitivity_scan_tfboard_ablation/hopper_set2_seed${SEED}"
new_win_run "h3" "\$H3" "sensitivity_scan_tfboard_ablation/hopper_set3_seed${SEED}"

new_win_run "w1" "\$W1" "sensitivity_scan_tfboard_ablation/wipe_set1_seed${SEED}"
new_win_run "w2" "\$W2" "sensitivity_scan_tfboard_ablation/wipe_set2_seed${SEED}"
new_win_run "w3" "\$W3" "sensitivity_scan_tfboard_ablation/wipe_set3_seed${SEED}"

new_win_run "a1" "\$A1" "sensitivity_scan_tfboard_ablation/ant_set1_seed${SEED}"
new_win_run "a2" "\$A2" "sensitivity_scan_tfboard_ablation/ant_set2_seed${SEED}"
new_win_run "a3" "\$A3" "sensitivity_scan_tfboard_ablation/ant_set3_seed${SEED}"

new_win_run "c1" "\$C1" "sensitivity_scan_tfboard_ablation/cheetah_set1_seed${SEED}"
new_win_run "c2" "\$C2" "sensitivity_scan_tfboard_ablation/cheetah_set2_seed${SEED}"
new_win_run "c3" "\$C3" "sensitivity_scan_tfboard_ablation/cheetah_set3_seed${SEED}"

new_win_run "d1" "\$D1" "sensitivity_scan_tfboard_ablation/door_set1_seed${SEED}"
new_win_run "d2" "\$D2" "sensitivity_scan_tfboard_ablation/door_set2_seed${SEED}"
new_win_run "d3" "\$D3" "sensitivity_scan_tfboard_ablation/door_set3_seed${SEED}"

new_win_run "l1" "\$L1" "sensitivity_scan_tfboard_ablation/lift_set1_seed${SEED}"
new_win_run "l2" "\$L2" "sensitivity_scan_tfboard_ablation/lift_set2_seed${SEED}"
new_win_run "l3" "\$L3" "sensitivity_scan_tfboard_ablation/lift_set3_seed${SEED}"
