...
mkdir -p "$TMPDIR"
# # Hopper
# H1="$TMPDIR/exp_h1_seed${SEED}_beta03.sh"
# mkcmd "$H1" 0 \
#   "--env_is_gym=0 \\
...
#   --critic_lr 1e-4 \\
#   --beta 0.3"
# H2="$TMPDIR/exp_h2_seed${SEED}_beta05.sh"
# mkcmd "$H2" 1 \
#   "--env_is_gym=0 \\
#   --algorithm=avatar_dice \\
#   --env_id=Hopper \\
...
#   --critic_lr 1e-4 \\
#   --beta 0.5"
# H3="$TMPDIR/exp_h3_seed${SEED}_beta07.sh"
# mkcmd "$H3" 2 \
#   "--env_is_gym=0 \\
#   --algorithm=avatar_dice \\
#   --env_id=Hopper \\
...
# # Ant
# A1="$TMPDIR/exp_a1_seed${SEED}_beta03.sh"
# mkcmd "$A1" 3 \
#   "--env_is_gym=0 \\
#   --algorithm=avatar_dice \\
#   --env_id=Ant \\
...
#   --beta 0.3"
# A2="$TMPDIR/exp_a2_seed${SEED}_beta05.sh"
# mkcmd "$A2" 0 \
#   "--env_is_gym=0 \\
#   --algorithm=avatar_dice \\
#   --env_id=Ant \\
...
#   --imperfect_dataset_default_info '([\"expert-v2\",\"random-v2\"], [1,100])' \\
#   --beta 0.5"
# A3="$TMPDIR/exp_a3_seed${SEED}_beta07.sh"
# mkcmd "$A3" 1 \
#   "--env_is_gym=0 \\
#   --algorithm=avatar_dice \\
#   --env_id=Ant \\
...
# Door
D1="$TMPDIR/exp_d1_seed${SEED}_beta03.sh"
mkcmd "$D1" 0 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Door \\
  ...
  --expert_num_traj 1 \\
  --imperfect_dataset_default_info '([\"expert-v2\",\"random-v2\"], [5,100])' \\
  --beta 0.3 \\
  --fixed_beta=True"
D2="$TMPDIR/exp_d2_seed${SEED}_beta07.sh"
mkcmd "$D2" 1 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Door \\
  ...
  --beta 0.7 \\
  --fixed_beta=True"
D3="$TMPDIR/exp_d3_seed${SEED}_adapt.sh"
mkcmd "$D3" 2 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Door \\
...
# Lift
L1="$TMPDIR/exp_l1_seed${SEED}_beta03.sh"
mkcmd "$L1" 0 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Lift \\
  ...
  --beta 0.3 \\
  --fixed_beta=True"
L2="$TMPDIR/exp_l2_seed${SEED}_beta07.sh"
mkcmd "$L2" 1 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Lift \\
  ...
  --beta 0.7 \\
  --fixed_beta=True"
L3="$TMPDIR/exp_l3_seed${SEED}_adapt.sh"
mkcmd "$L3" 2 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Lift \\
...
# new_win_run "h1" "$H1" "tfboard/avatardice/hopper_seed${SEED}_beta03"
# new_win_run "h2" "$H2" "tfboard/avatardice/hopper_seed${SEED}_beta05"
# new_win_run "h3" "$H3" "tfboard/avatardice/hopper_seed${SEED}_beta07"
# new_win_run "w1" "$W1" "tfboard/avatardice/wipe_set1_seed${SEED}"
# new_win_run "w2" "$W2" "tfboard/avatardice/wipe_set2_seed${SEED}"
# new_win_run "w3" "$W3" "tfboard/avatardice/wipe_set3_seed${SEED}"
# new_win_run "a1" "$A1" "tfboard/avatardice/ant_seed${SEED}_beta03"
# new_win_run "a2" "$A2" "tfboard/avatardice/ant_seed${SEED}_beta05"
# new_win_run "a3" "$A3" "tfboard/avatardice/ant_seed${SEED}_beta07"
# new_win_run "c1" "$C1" "tfboard/avatardice/cheetah_set1_seed${SEED}"
# new_win_run "c2" "$C2" "tfboard/avatardice/cheetah_set2_seed${SEED}"
# new_win_run "c3" "$C3" "tfboard/avatardice/cheetah_set3_seed${SEED}"
new_win_run "d1" "$D1" "tfboard/avatardice/door_seed${SEED}_beta03"
new_win_run "d2" "$D2" "tfboard/avatardice/door_seed${SEED}_beta07"
new_win_run "d3" "$D3" "tfboard/avatardice/door_seed${SEED}_adapt"
new_win_run "l1" "$L1" "tfboard/avatardice/lift_seed${SEED}_beta03"
new_win_run "l2" "$L2" "tfboard/avatardice/lift_seed${SEED}_beta07"
new_win_run "l3" "$L3" "tfboard/avatardice/lift_seed${SEED}_adapt"
