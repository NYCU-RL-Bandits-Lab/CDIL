...
python train_il.py \
  ...
  --actor_lr 5e-5 \
  --tb_path=sensitivity_scan_tfboard_ablation/hopper_set1_seed0 \
  --seed 0
...
python train_il.py \
  ...
  --critic_lr 1e-4 \
  --tb_path=sensitivity_scan_tfboard_ablation/wipe_set1_seed0 \
  --seed 0
...
python train_il.py \
  ...
  --tb_path=sensitivity_scan_tfboard_ablation/ant_set1_seed0 \
  --seed 0
...
python train_il.py \
  ...
  --expert_num_traj 1 \
  --imperfect_dataset_default_info '(["expert-v2","random-v2"], [1,100])' \
  --tb_path=sensitivity_scan_tfboard_ablation/cheetah_set1_seed0 \
  --seed 0
...
python train_il.py \
  ...
  --load_hdf5_dataset=0 \
  --tb_path=sensitivity_scan_tfboard_ablation/door_set1_seed0 \
  --log_interval=10000 \
...
python train_il.py \
  ...
  --load_hdf5_dataset=0 \
  --tb_path=sensitivity_scan_tfboard_ablation/lift_set1_seed0 \
  --log_interval=10000 \
