...
new_win_run "h1" "$H1" "tfboard/smodice/hopper_set1_seed${SEED}"
# new_win_run "h2" "$H2" "tfboard/smodice/hopper_set2_seed${SEED}"
# new_win_run "h3" "$H3" "tfboard/smodice/hopper_set3_seed${SEED}"
new_win_run "w1" "$W1" "tfboard/smodice/wipe_set1_seed${SEED}"
# new_win_run "w2" "$W2" "tfboard/smodice/wipe_set2_seed${SEED}"
# new_win_run "w3" "$W3" "tfboard/smodice/wipe_set3_seed${SEED}"
new_win_run "a1" "$A1" "tfboard/smodice/ant_set1_seed${SEED}"
# new_win_run "a2" "$A2" "tfboard/smodice/ant_set2_seed${SEED}"
# new_win_run "a3" "$A3" "tfboard/smodice/ant_set3_seed${SEED}"
new_win_run "c1" "$C1" "tfboard/smodice/cheetah_set1_seed${SEED}"
# new_win_run "c2" "$C2" "tfboard/smodice/cheetah_set2_seed${SEED}"
# new_win_run "c3" "$C3" "tfboard/smodice/cheetah_set3_seed${SEED}"
new_win_run "d1" "$D1" "tfboard/smodice/door_set1_seed${SEED}"
# new_win_run "d2" "$D2" "tfboard/smodice/door_set2_seed${SEED}"
# new_win_run "d3" "$D3" "tfboard/smodice/door_set3_seed${SEED}"
new_win_run "l1" "$L1" "tfboard/smodice/lift_set1_seed${SEED}"
# new_win_run "l2" "$L2" "tfboard/smodice/lift_set2_seed${SEED}"
# new_win_run "l3" "$L3" "tfboard/smodice/lift_set3_seed${SEED}"
