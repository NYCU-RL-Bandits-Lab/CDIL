...
# H100="$TMPDIR/exp_h100_seed${SEED}.sh"
# mkcmd "$H100" 6 \
#   "--env_is_gym=0 \\
...
# W100="$TMPDIR/exp_w100_seed${SEED}.sh"
# mkcmd "$W100" 7 \
#   "--env_is_gym=0 \\
#   --algorithm=avatar_dice \\
#   --env_id=Wipe \\
...
#   --log_interval=10000 \\
#   --critic_lr 1e-4 \\
#   --pretrained_model_path=pretrained_models/new_models/wipe_source_100.pickle \\
#   --flow_model_path=./flow_model/wipe/model/wipe_flow_seed1.pt \\
#   --flow_model_action_path=./flow_model/wipe/model_action/wipe_flow_seed1.pt \\
#   --expert_num_traj 1 \\
#   --imperfect_dataset_default_info '([\"expert-v2\",\"random-v2\"], [10,50])'"

# new_win_run "h100" "$H100" "tfboard/avatardice/new_pretrained/hopper_seed${SEED}_source100"
# new_win_run "w100" "$W100" "tfboard/avatardice/new_pretrained/wipe_seed${SEED}_source100"

# Hopper
H1="$TMPDIR/exp_hopper_seed${SEED}_beta03.sh"
mkcmd "$H1" 0 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Hopper \\
  ...
  --load_hdf5_dataset=0 \\
  --log_interval=10000 \\
  --pretrained_model_path=pretrained_models/low_quality/hopper_low_quality.pickle \\
  --flow_model_path=./flow_model/hopper/model/hopper_flow_seed1.pt \\
  --flow_model_action_path=./flow_model/hopper/model_action/hopper_flow_seed1.pt \\
  --critic_lr 1e-4 \\
  --expert_num_traj 1 \\
  ...
  --beta 0.3 \\
  --fixed_beta True"
H2="$TMPDIR/exp_hopper_seed${SEED}_beta05.sh"
mkcmd "$H2" 1 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Hopper \\
  ...
  --beta 0.5 \\
  --fixed_beta True"
H3="$TMPDIR/exp_hopper_seed${SEED}_beta07.sh"
mkcmd "$H3" 2 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Hopper \\
  ...
  --beta 0.7 \\
  --fixed_beta True"
H4="$TMPDIR/exp_hopper_seed${SEED}_adapt.sh"
mkcmd "$H4" 3 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Hopper \\
...
# Ant
A1="$TMPDIR/exp_ant_seed${SEED}_beta03.sh"
mkcmd "$A1" 4 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Ant \\
  ...
  --load_hdf5_dataset=0 \\
  --log_interval=10000 \\
  --pretrained_model_path=pretrained_models/low_quality/ant_low_quality.pickle \\
  ...
  --beta 0.3 \\
  --fixed_beta True"
A2="$TMPDIR/exp_ant_seed${SEED}_beta05.sh"
mkcmd "$A2" 5 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Ant \\
  ...
  --beta 0.5 \\
  --fixed_beta True"
A3="$TMPDIR/exp_ant_seed${SEED}_beta07.sh"
mkcmd "$A3" 6 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Ant \\
  ...
  --beta 0.7 \\
  --fixed_beta True"
A4="$TMPDIR/exp_ant_seed${SEED}_adapt.sh"
mkcmd "$A4" 7 \
  "--env_is_gym=0 \\
  --algorithm=avatar_dice \\
  --env_id=Ant \\
...
new_win_run "h1" "$H1" "tfboard/avatardice/new_pretrained_fixed_beta/hopper_seed${SEED}_beta03"
new_win_run "h2" "$H2" "tfboard/avatardice/new_pretrained_fixed_beta/hopper_seed${SEED}_beta05"
new_win_run "h3" "$H3" "tfboard/avatardice/new_pretrained_fixed_beta/hopper_seed${SEED}_beta07"
new_win_run "h4" "$H4" "tfboard/avatardice/new_pretrained_fixed_beta/hopper_seed${SEED}_adapt"
new_win_run "a1" "$A1" "tfboard/avatardice/new_pretrained_fixed_beta/ant_seed${SEED}_beta03"
new_win_run "a2" "$A2" "tfboard/avatardice/new_pretrained_fixed_beta/ant_seed${SEED}_beta05"
new_win_run "a3" "$A3" "tfboard/avatardice/new_pretrained_fixed_beta/ant_seed${SEED}_beta07"
new_win_run "a4" "$A4" "tfboard/avatardice/new_pretrained_fixed_beta/ant_seed${SEED}_adapt"
...
#   --load_hdf5_dataset=0 \\
#   --log_interval=10000 \\
#   --pretrained_model_path=pretrained_models/new_models/door_source_1.pickle \\
...
#   --load_hdf5_dataset=0 \\
#   --log_interval=10000 \\
#   --pretrained_model_path=pretrained_models/new_models/door_source_100.pickle \\
#   --flow_model_path=./flow_model/door/model/door_flow_seed1.pt \\
#   --flow_model_action_path=./flow_model/door/model_action/door_flow_seed1.pt \\
#   --expert_num_traj 1 \\
#   --imperfect_dataset_default_info '([\"expert-v2\",\"random-v2\"], [1,100])'"
...
#   --load_hdf5_dataset=0 \\
#   --log_interval=10000 \\
#   --pretrained_model_path=pretrained_models/new_models/lift_source_1.pickle \\
...
#   --load_hdf5_dataset=0 \\
#   --log_interval=10000 \\
#   --pretrained_model_path=pretrained_models/new_models/lift_source_100.pickle \\
#   --flow_model_path=./flow_model/lift/model/lift_flow_seed1.pt \\
#   --flow_model_action_path=./flow_model/lift/model_action/lift_flow_seed1.pt \\
#   --expert_num_traj 1 \\
#   --imperfect_dataset_default_info '([\"expert-v2\",\"random-v2\"], [1,100])'"
...
# new_win_run "a1" "$A1" "tfboard/avatardice/new_pretrained/ant_seed${SEED}_source1"
# new_win_run "a2" "$A2" "tfboard/avatardice/new_pretrained/ant_seed${SEED}_source100"
# new_win_run "c1" "$C1" "tfboard/avatardice/new_pretrained/cheetah_seed${SEED}_source1"
# new_win_run "c2" "$C2" "tfboard/avatardice/new_pretrained/cheetah_seed${SEED}_source100"
# new_win_run "d1" "$D1" "tfboard/avatardice/new_pretrained/door_seed${SEED}_source1"
# new_win_run "d2" "$D2" "tfboard/avatardice/new_pretrained/door_seed${SEED}_source100"
# new_win_run "l1" "$L1" "tfboard/avatardice/new_pretrained/lift_seed${SEED}_source1"
# new_win_run "l2" "$L2" "tfboard/avatardice/new_pretrained/lift_seed${SEED}_source100"
