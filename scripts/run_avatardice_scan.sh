...
new_win_run "h" "$H" "tfboard/avatardice/hopper_seed${SEED}"
new_win_run "w" "$W" "tfboard/avatardice/wipe_seed${SEED}"
new_win_run "a" "$A" "tfboard/avatardice/ant_seed${SEED}"
new_win_run "c" "$C" "tfboard/avatardice/cheetah_seed${SEED}"
new_win_run "d" "$D" "tfboard/avatardice/door_seed${SEED}"
new_win_run "l" "$L" "tfboard/avatardice/lift_seed${SEED}"
