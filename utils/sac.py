...
import utils.sac_models as sac_models


class SAC(object):
    def __init__(self, obs_dim, action_dim, action_range, batch_size, args, config):
        ...
        self.critic = sac_models.DoubleQCritic(agent_cfg.obs_dim, agent_cfg.action_dim, agent_cfg.hidden_dim, agent_cfg.hidden_depth, args=args).to(self.device)

        self.critic_target = sac_models.DoubleQCritic(agent_cfg.obs_dim, agent_cfg.action_dim, agent_cfg.hidden_dim, agent_cfg.hidden_depth, args=args).to(self.device)
        self.critic_target.load_state_dict(self.critic.state_dict())

        self.actor = sac_models.DiagGaussianActor(agent_cfg.obs_dim, agent_cfg.action_dim, agent_cfg.hidden_dim, agent_cfg.hidden_depth, agent_cfg.log_std_bounds).to(self.device)
