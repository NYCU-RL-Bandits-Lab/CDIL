...
def get_parser():
    ...
    parser.add_argument(
        "--imperfect_dataset_default_info",
        default=(["expert-v2", "random-v2"], [50, 500]),
    )  # source: [400, 1600] , target: [50, 200]\[10, 100], default=(["expert-v2", "random-v2"], [1, 100]), default=(["expert-v1", "cloned-v1"], [400, 1600])
    ...
    parser.add_argument("--logstd_range", default=(-5.0, 2.0))
